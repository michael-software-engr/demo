...
import { loadRepo, loadStargazers } from '../../redux/modules/reduxRealWorldExample/actions';
import reduxRealWorldExample from '../../redux/modules/reduxRealWorldExample/index';
...
// ... necessary edits
const reduxRealWorldExampleModuleKey = reduxRealWorldExample.getKey();
...
const mapStateToProps = (state, ownProps) => {
  ...
  } = state[reduxRealWorldExampleModuleKey];
  // const {
  //   pagination: { stargazersByRepo },
  //   entities: { users, repos }
  // } = state
