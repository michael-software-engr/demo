...
import { unconnectedSetFilterCompanyName } from '../../../../redux/modules/stocks/actions/index';
...
class CompanyName extends React.Component {
  ...
  handleInputChange = (event, { value }) => {
    ...
    this.setState(
      newState,
      () => { this.props.setFilterCompanyName(newState); }
    );
  }
  ...
  render() {
    ...
    return (
      <Input
        ...
        value={searchTerm}
        className={classNames(filterClassName, 'CompanyName')}
      />
    );
  }
}
...
CompanyName.propTypes = {
  ...
  setFilterCompanyName: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {
  setFilterCompanyName: unconnectedSetFilterCompanyName
})(CompanyName);
