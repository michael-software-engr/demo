...
import { unconnectedSetFilterExpectedMove } from '../../../../redux/modules/stocks/actions/index';
...
class ExpectedMove extends React.Component {
  state = initialState
  ...
  handleOnSubmit = (event) => {
    ...
    this.props.setFilterExpectedMove({ operator: localStateOperator, operand: localStateOperand });
  }

  handleOnReset = (event) => {
    event.preventDefault();
    this.setState(initialState);
    this.props.setFilterExpectedMove();
  }
      ...
      showFilter ? (
        [
          ...
          >
            <Segment
              raised
              className={classNames(filterClassName, 'ExpectedMove')}
            >
              <FilterForm
...
ExpectedMove.propTypes = {
  // Injected by React Redux
  setFilterExpectedMove: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {
  setFilterExpectedMove: unconnectedSetFilterExpectedMove
})(ExpectedMove);
