class TradingDaysController < ApplicationController
  # before_action :set_trading_day, only: %i[show edit update destroy]

  def by_years
    permitted_params = params.permit :years
    @trading_days = TradingDay.where year: permitted_params.fetch(:years)
  end
  ...
  #   params.require(:trading_day).permit(
  #     :year, :month, :day, :date,
  #     :dow, :nasdaq, :spy, :dow_change, :nasdaq_change, :spy_change,
  #     :other
  #   )
  # end
end
